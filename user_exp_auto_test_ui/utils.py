...
class Utils:
    ...
    @staticmethod
    def run_as_admin(cmd,password):
        try:
            process = subprocess.Popen(['runas', '/noprofile', '/user:ADMIN', cmd], 
            ...
            print("Error: 'runas' command not found. This method is specific to Windows.")
